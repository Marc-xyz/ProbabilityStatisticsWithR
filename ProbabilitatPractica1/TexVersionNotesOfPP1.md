<!--pandoc -s -V geometry:"margin=0.3in,landscape" -o Memoria.pdf  NotesOfPP1.md-->
...
| `factorial(n)`| Dóna $n$ factorial, $n!$. |`factorial(4); factorial(5); factorial(6);` |`[1] 24` `[1] 120` `[1] 720`|
...
| Per dibuixar fragments de funcions o corbes planes parametritzades. Observem que `col=2` fa referència a que el color per efectuar el gràfic és el _color 2_, que tal com podem veure, fa referència al color vermell. |`curve(exp(-x^2),from=-3,to=3,col=2)` | `#VeureCurveBellGauss.png`|
...
|![`CurveLinesLegendBellGauss.png`](ImagesOfPP1/CurveLinesLegendBellGauss_resized_60.png)|
...
|------------------------------------------------|
|![`CosSin02.png`](ImagesOfPP1/CosSin02_resized_60.png)|
|`CosSin02.png`|
...
|`abline(h=0,v=0)`|
|------------------------------------------------|
|![`CosSin04.png`](ImagesOfPP1/CosSin04_resized_60.png)|
|`CosSin04.png`|
...
|------------------------------------------------------------------------------------|
|![`TwoPicturesInOne01.png`](ImagesOfPP1/TwoPicturesInOne01_resized_60.png)|
...
|-----------------------------------------------------------------------------------------|
|![`PlotWithSeq.png`](ImagesOfPP1/PlotWithSeq_resized_60.png)|
|`PlotWithSeq.png`|
